...
def display_work_records(records, table_name, num_columns=1, thumbnail_width=640):
...
def work_page(table_name):
    ...
    # Display records
    if records:
        display_work_records(records, table_name=table_name, num_columns=1, thumbnail_width=640)
    else:
        st.write("No records found.")

# Call the function with the table name
if __name__ == "__main__":
    work_page("Color_Curves")